...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //User - monoose methods available
  // user - your created user - u get your methods that u created in modal
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
  ...
  // take confirmPassword from req.body above
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  const { username } = req.params; //params = not body but from url
  if (!username?.trim()) {
